...
- (void)initViews {
    ...
    int initialClearAreaSize = self.frame.size.width / 4;
...
- (void)setImage:(UIImage *)image {
    ...
    UIImage *blur;
    if (self.blurred) {
        blur = [image blurredImageWithRadius:10 iterations:1 tintColor:[UIColor colorWithRed:0 green:0 blue:0 alpha:0.1]];
    } else {
